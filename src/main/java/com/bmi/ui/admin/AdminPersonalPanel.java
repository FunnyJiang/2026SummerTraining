...
/**
 * 管理员个人中心 - BMI实时更新 + 保存后同步刷新统计和用户管理
 */
public class AdminPersonalPanel extends JPanel {
    ...
    private JLabel lblBMI;  // ★ 实例字段，用于实时更新

    public AdminPersonalPanel(User user, JFrame frame) {
    ...
    private void initUI() {
        ...
        txtAge.setText(currentUser.getAge() > 0 ? String.valueOf(currentUser.getAge()) : "");
        ...
        JButton btnSave = UIUtil.createPrimaryButton("保存修改");
        ...
        txtOldPassword = UIUtil.createPasswordField(20);
        ...
        gbc.gridx = 1; gbc.gridwidth = 2;
        txtNewPassword = UIUtil.createPasswordField(20);
        ...
        row++;
        gbc.gridx = 0; gbc.gridy = row; gbc.gridwidth = 3;
        JButton btnChangePwd = UIUtil.createPrimaryButton("修改密码");
        ...
        btnSave.addActionListener(e -> {
            try {
                ...
                if (userService.updateProfile(currentUser)) {
                    ...
                    // ★ 同步刷新首页统计数据和用户管理列表
                    if (parentFrame instanceof AdminMainFrame) {
                        ((AdminMainFrame) parentFrame).refreshAllData();
                    }
                } else {
    ...
    private void updateBMILabel() {
        ...
        if (heightStr.isEmpty() || weightStr.isEmpty()) {
            ...
            lblBMI.setForeground(UIUtil.USER_TEXT_LIGHT);
            return;
        }
